...
public class ModFoodComponents {
    ...
    public static final FoodComponent GLASS_CUP = new FoodComponent.Builder().nutrition(2).saturationModifier(0.1F)
            .statusEffect(new StatusEffectInstance(ModEffects.UMAMI,200,1),1.0F).build();

    public static final FoodComponent FRICO_SLICE = new FoodComponent.Builder().nutrition(5).saturationModifier(0.7F).build();
